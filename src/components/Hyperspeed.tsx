...
const Hyperspeed = ({
  ...
  useEffect(() => {
    ...
    class HyperspeedApp {
      ...
      renderPass: any; bloomPass: any;
      onWindowResizeBound: () => void;
      onMouseDownBound: (ev: any) => void;
      onMouseUpBound: (ev: any) => void;
      ...
      init() {
        ...
        this.container.addEventListener('mouseout', this.onMouseUpBound);
        this.tick();
      }
      ...
      dispose() {
        ...
        this.container?.removeEventListener('mouseout', this.onMouseUpBound);
      }
    ...
    const options = { ...effectOptions } as any;
    options.distortion = distortions[options.distortion] || distortions.turbulentDistortion;
    const myApp = new HyperspeedApp(container, options);
